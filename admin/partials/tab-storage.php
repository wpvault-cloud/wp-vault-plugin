    ...
    <?php if (!$registered): ?>
        <div class="wpv-notice wpv-notice-warning">
            <p>
                ...
                <?php esc_html_e('Please register your site in Settings to use cloud storage.', 'wp-vault'); ?>
            </p>
                <a href="<?php echo esc_url(admin_url('admin.php?page=wp-vault&tab=settings')); ?>" class="button button-primary">
