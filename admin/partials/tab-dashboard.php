...
function wpvault_display_dashboard_tab()
{
    ...
    <div class="wpv-tab-content" id="wpv-tab-dashboard">
            ...
            <div class="wpv-backup-controls">
                ...
                <div class="wpv-backup-actions">
                    ...
                    <a href="<?php echo esc_url(admin_url('admin.php?page=wp-vault&tab=backups')); ?>"
                        ...
                        <?php esc_html_e('View All Backups', 'wp-vault'); ?>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="wpv-section">
            <h2><?php esc_html_e('Recent Backups', 'wp-vault'); ?></h2>
            ...
            <?php else: ?>
                <p class="wpv-backup-summary">
                    <?php
                    /* translators: 1: number of recent backups shown, 2: total number of backups */
                    printf(esc_html__('Showing last %1$d backup(s) of %2$d total', 'wp-vault'), count($recent_backups), count($all_backups));
                    ?>
                </p>
                ...
                <p style="margin-top: 16px;">
                    <a href="<?php echo esc_url(admin_url('admin.php?page=wp-vault&tab=backups')); ?>" class="button">
                        <?php esc_html_e('View All Backups', 'wp-vault'); ?>
                    </a>
                </p>
            <?php endif; ?>
