    ...
    <?php if (!$registered): ?>
        <div class="notice notice-warning inline">
            <p>
                ...
                <?php _e('Please register your site in the General tab to use cloud storage.', 'wp-vault'); ?>
            </p>
        </div>
    <?php else: ?>

        <!-- Security Explanation Section -->
        <div class="card" style="background: #f0f9ff; border-left: 4px solid #0ea5e9; padding: 20px; margin: 20px 0;">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($storage['is_primary']): ?>
                                    <span style="color: green; font-weight: bold;">✓ <?php _e('Primary', 'wp-vault'); ?></span>
                                <?php else: ?>
        ...
        <h3 style="margin-top: 30px;"><?php _e('Local Downloads', 'wp-vault'); ?></h3>
        <div class="notice notice-info inline">
            <p>
